...
namespace MessangersUI.HttpGetRequest
{
            ...
            try
            {
                ...
                if (recpon.IsSuccessStatusCode)
                {
                    ...
                    if (result != null)
                    {
                        ...
                        var deserialize = JsonSerializer.Deserialize<List<IpIfo>>(properties) ?? new List<IpIfo>();
                        return deserialize;
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (result != null)
                    {
                        ...
                        var deserializeline1 = JsonSerializer.Deserialize<ErrorBodyData>(propertys1)
                            ?? new ErrorBodyData();
                        var deserealizeline2 = JsonSerializer.Deserialize<ErrorBodyData>(propertys2)
                            ?? new ErrorBodyData();
