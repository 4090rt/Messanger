...
namespace Messangers.EthernetRequest
{
    public class RequesetInfoProviders
    {
        ...
        public RequesetInfoProviders(ILogger<RequesetInfoProviders> loggger, IHttpClientFactory httpClientFactory, Deserialize deserialize, IMemoryCache memoryCache)
        {
            _loggger = loggger;
